...
red_model.load_checkpoint(f"black_model_{bootstrap_version}", identifier)
...
for version in range(0, bootstrap_version):
	red_wins = 0
	black_wins = 0
	red_illegal_total = 0
	red_move_total = 0
	...
	black_model.load_checkpoint(f"black_model_{version}", identifier)
	red_game_set = []
	black_game_set = []
	games = []
	done = False
